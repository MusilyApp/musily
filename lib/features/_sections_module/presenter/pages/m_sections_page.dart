                  ...
                  RefreshIndicator(
                    ...
                    child: ListView(
                      children: [
                        ...
                        if (!coreData.offlineMode &&
                            dataSections.carouselRecommendedTracks.isNotEmpty)
                          Column(
                        ...
                        if (!coreData.offlineMode &&
                            dataSections.gridRecommendedTracks.isNotEmpty) ...[
                          Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              Padding(
                              ...
                              SizedBox(
                                ...
                                child: GridView.builder(
                                  ...
                                  itemBuilder: (context, index) {
                                    final recommendation = dataSections
                                        .gridRecommendedTracks[index];
                          ...
                          Builder(
                            builder: (context) {
                              if (dataSections.loadingSections) {
                                ...
                                return Skeletonizer(
                                  child:
                                      Column(children: loadingPlaceholderItems),
                                );
                              }
                              return Column(
                                children: [
